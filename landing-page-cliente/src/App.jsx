...
function App() {
  ...
  const handleConversion = () => {
    if (typeof window.gtag !== 'undefined') {
      window.gtag('event', 'conversion', {
        'send_to': 'AW-10949438287/FY4pCLeQ5tMYEM_WjOUo'
      });
    }
  };
  ...
  return (
    <div className="App">
      ...
      <header className="header-top">
        <div className="container nav-flex">
          ...
          <nav className="nav-menu">
            ...
            <a href={whatsappLink} className="btn-header-cta" onClick={handleConversion}>
              Orçamento Rápido
            </a>
          </nav>
        </div>
        ...
        <div className="container hero-grid">
          <div className="hero-text">
            ...
            <div className="cta-group">
              <a href={whatsappLink} className="btn-large pulse-btn" onClick={handleConversion}>
      ...
      <a href={whatsappLink} className="whatsapp-float" target="_blank" rel="noreferrer" onClick={handleConversion}>
